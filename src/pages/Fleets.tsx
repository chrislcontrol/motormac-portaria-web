...
export default function () {
    ...
    return React.createElement('div', { 'id': 'wrapper' }, React.createElement('nav', { 'className': 'navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0' }, React.createElement('div', { 'className': 'container-fluid d-flex flex-column p-0' }, React.createElement('a', {
        ...
        'className': 'dropdown-item d-flex align-items-center',
        'href': '#'
    }, React.createElement('div', { 'className': 'dropdown-list-image me-3' }, React.createElement('div', { 'className': 'bg-success status-indicator' })), React.createElement('div', { 'className': 'fw-bold' }, React.createElement('div', { 'className': 'text-truncate' }, React.createElement('span', {}, 'Hi there! I am wondering if you can help me with a problem I\'ve been having.')), React.createElement('p', { 'className': 'small text-gray-500 mb-0' }, 'Emily Fowler - 58m'))), React.createElement('a', {
        'className': 'dropdown-item d-flex align-items-center',
        'href': '#'
    }, React.createElement('div', { 'className': 'dropdown-list-image me-3' }, React.createElement('div', { 'className': 'status-indicator' })), React.createElement('div', { 'className': 'fw-bold' }, React.createElement('div', { 'className': 'text-truncate' }, React.createElement('span', {}, 'I have the photos that you ordered last month!')), React.createElement('p', { 'className': 'small text-gray-500 mb-0' }, 'Jae Chun - 1d'))), React.createElement('a', {
        'className': 'dropdown-item d-flex align-items-center',
        'href': '#'
    }, React.createElement('div', { 'className': 'dropdown-list-image me-3' }, React.createElement('div', { 'className': 'bg-warning status-indicator' })), React.createElement('div', { 'className': 'fw-bold' }, React.createElement('div', { 'className': 'text-truncate' }, React.createElement('span', {}, 'Last month\'s report looks great, I am very happy with the progress so far, keep up the good work!')), React.createElement('p', { 'className': 'small text-gray-500 mb-0' }, 'Morgan Alvarez - 2d'))), React.createElement('a', {
        'className': 'dropdown-item d-flex align-items-center',
        'href': '#'
        ...
        'data-bs-toggle': 'dropdown',
        'href': '#'
    }, React.createElement('span', { 'className': 'd-none d-lg-inline me-2 text-gray-600 small' }, `${LocalStorage.getUser().username}`)), React.createElement('div', { 'className': 'dropdown-menu shadow dropdown-menu-end animated--grow-in' }, React.createElement('a', {
        ...
        'className': 'dropdown-item',
        'href': '#'
    }, React.createElement('i', { 'className': 'fas fa-sign-out-alt fa-sm fa-fw me-2 text-gray-400' }), '\xA0Logout'))))))), React.createElement('div', { 'className': 'container-fluid' }, React.createElement('h3', { 'className': 'text-dark mb-4' }, 'Veículos internos'), React.createElement('div', { 'className': 'card shadow' }, React.createElement('div', { 'className': 'card-header py-3' }, React.createElement('p', { 'className': 'text-primary m-0 fw-bold' }, 'Veículos internos em viagem ou estacionados')), React.createElement('div', { 'className': 'card-body' }, React.createElement('div', { 'className': 'row' }, React.createElement('div', { 'className': 'col-md-6 text-nowrap' }, React.createElement('div', {
        'id': 'dataTable_length',
        ...
        'id': 'dataTable'
    }, React.createElement('thead', {}, React.createElement('tr', {}, React.createElement('th', {}, 'Placa'), React.createElement('th', {}, 'Veículo'), React.createElement('th', {}, 'KM Atual'), React.createElement('th', {}, 'Status'))), React.createElement('tbody', {}, React.createElement('tr', {}, React.createElement('td', {}, 'Airi Satou'), React.createElement('td', {}, 'Accountant'), React.createElement('td', {}, 'Tokyo'), React.createElement('td', {}, '33')), React.createElement('tr', {}, React.createElement('td', {}, 'Angelica Ramos'), React.createElement('td', {}, 'Chief Executive Officer(CEO)'), React.createElement('td', {}, 'London'), React.createElement('td', {}, '47')), React.createElement('tr', {}, React.createElement('td', {}, 'Ashton Cox'), React.createElement('td', {}, 'Junior Technical Author'), React.createElement('td', {}, 'San Francisco'), React.createElement('td', {}, '66')), React.createElement('tr', {}, React.createElement('td', {}, 'Bradley Greer'), React.createElement('td', {}, 'Software Engineer'), React.createElement('td', {}, 'London'), React.createElement('td', {}, '41')), React.createElement('tr', {}, React.createElement('td', {}, 'Brenden Wagner'), React.createElement('td', {}, 'Software Engineer'), React.createElement('td', {}, 'San Francisco'), React.createElement('td', {}, '28')), React.createElement('tr', {}, React.createElement('td', {}, 'Brielle Williamson'), React.createElement('td', {}, 'Integration Specialist'), React.createElement('td', {}, 'New York'), React.createElement('td', {}, '61')), React.createElement('tr', {}, React.createElement('td', {}, 'Bruno Nash', React.createElement('br', {})), React.createElement('td', {}, 'Software Engineer'), React.createElement('td', {}, 'London'), React.createElement('td', {}, '38')), React.createElement('tr', {}, React.createElement('td', {}, 'Caesar Vance'), React.createElement('td', {}, 'Pre-Sales Support'), React.createElement('td', {}, 'New York'), React.createElement('td', {}, '21')), React.createElement('tr', {}, React.createElement('td', {}, 'Cara Stevens'), React.createElement('td', {}, 'Sales Assistant'), React.createElement('td', {}, 'New York'), React.createElement('td', {}, '46')), React.createElement('tr', {}, React.createElement('td', {}, 'Cedric Kelly'), React.createElement('td', {}, 'Senior JavaScript Developer'), React.createElement('td', {}, 'Edinburgh'), React.createElement('td', {}, '22'))), React.createElement('tfoot', {}, React.createElement('tr', {}, React.createElement('td', {}, React.createElement('button', {
        'className': 'btn btn-primary',
        'type': 'button', 
        'onClick': () => {navigate('cadastrar')}
    }, 'Cadastrar veículo')), React.createElement('td', {}))))), React.createElement('div', { 'className': 'row' }, React.createElement('div', { 'className': 'col-md-6 align-self-center' }, React.createElement('p', {
        'id': 'dataTable_info',
