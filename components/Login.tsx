      ...
      <ThemeProvider theme={theme}>
        <Grid container component="main" sx={{ height: '100vh' }}>
          ...
          <Grid
            ...
            md={7}
            sx={{
              backgroundImage: `url(${PatioMotormacImage})`,
            ...
            >
              ...
              <Box component="form" noValidate onSubmit={props.onSubmit} sx={{ mt: 1 }}>
                ...
                <FormControl fullWidth>
                  <InputLabel id="select-branch">Filial</InputLabel>
                  <Select
                    labelId="select-branch"
                    id="selec-branch-selector"
                    value=""
                    label="Branch"
                    onChange={() => {}}
                  >
                ...
                <Typography variant="body2" color="text.secondary" align="center" sx= {{ mt: 5 }}>
                  {'Copyright © Christian Carlos Pereira da Silva, '}
